...
export class ScrollAreaDirective {
  ...
  // ... 
```
  - This rule does **NOT** apply to brain directives (files named `*-brain.ts` colocated with their core counterpart in `projects/shared-ui/src/lib/core/<component-name>/`); see `.cursor/rules/angular/brain-directive-component.md` for the brain-specific rule.
