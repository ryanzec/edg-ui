...
- `.cursor/rules/patterns/angular-component-effective-input-value.md`
- `.cursor/rules/patterns/angular-component-hide-empty-slot-projection.md`
...
- `.cursor/rules/patterns/angular-component-host-directives.md`
- `.cursor/rules/patterns/unsaved-changes.md`
...
If the component in in the `projects/shared-ui/src/lib/core` directory, it **MUST** follow the `.cursor/rules/patterns/brain-presentation-component-split.md` pattern.
