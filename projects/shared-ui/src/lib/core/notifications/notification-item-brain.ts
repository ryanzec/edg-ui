...
export const NOTIFICATION_ITEM_AUTO_CLOSE_IN_DEFAULT: number | undefined = undefined;

/** default value for the closeButtonAriaLabel input */
export const NOTIFICATION_ITEM_CLOSE_BUTTON_ARIA_LABEL_DEFAULT = 'Close notification';

/** default value for the resetTimerOnHover input */
export const NOTIFICATION_ITEM_RESET_TIMER_ON_HOVER_DEFAULT = false;
 ...
 */
@Directive({
  selector: '[orgNotificationItemBrain]',
  exportAs: 'orgNotificationItemBrain',
})
export class NotificationItemBrainDirective {
  ...
  public readonly autoCloseIn = input<number | undefined, number | null | undefined>(
    NOTIFICATION_ITEM_AUTO_CLOSE_IN_DEFAULT,
    {
  ...
  public readonly closeButtonAriaLabel = input<string>(NOTIFICATION_ITEM_CLOSE_BUTTON_ARIA_LABEL_DEFAULT);

  /** when true, pausing the auto-close timer (e.g. on hover) wipes any remaining time so resuming restarts the full duration */
  public readonly resetTimerOnHover = input<boolean>(NOTIFICATION_ITEM_RESET_TIMER_ON_HOVER_DEFAULT);
