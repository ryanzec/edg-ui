...
@Component({
  selector: 'story-notifications-default-story',
...
class NotificationsDefaultStory {
...
@Component({
  selector: 'story-notifications-positions-story',
  imports: [Notifications, Button, StorybookExampleContainer, StorybookExampleContainerSection],
  template: `
    <org-storybook-example-container
...
class NotificationsPositionsStory {
  private _notificationManager = inject(NotificationManager);
...
@Component({
  selector: 'story-notifications-colors-story',
  imports: [Notifications, Button, StorybookExampleContainer, StorybookExampleContainerSection],
  template: `
...
class NotificationsColorsStory {
  private _notificationManager = inject(NotificationManager);
...
@Component({
  selector: 'story-notifications-auto-close-story',
  imports: [Notifications, Button, StorybookExampleContainer, StorybookExampleContainerSection],
  template: `
    <org-storybook-example-container
...
class NotificationsAutoCloseStory {
  private _notificationManager = inject(NotificationManager);
...
@Component({
  selector: 'story-notifications-update-dynamically-story',
  imports: [Notifications, Button, StorybookExampleContainer, StorybookExampleContainerSection],
  template: `
    <org-storybook-example-container
...
class NotificationsUpdateDynamicallyStory {
  ...
  public updateToCloseableSuccess(): void {
    ...
    this._notificationManager.update(id, {
...
@Component({
  selector: 'story-notifications-accessibility-story',
  imports: [Notifications, Button, StorybookExampleContainer, StorybookExampleContainerSection],
  template: `
    <org-storybook-example-container
      title="Accessibility"
...
class NotificationsAccessibilityStory {
  private _notificationManager = inject(NotificationManager);
...
@Component({
  selector: 'story-notifications-link-action-story',
  imports: [
    Notifications,
    Button,
    Link,
...
class NotificationsLinkActionStory {
  private _notificationManager = inject(NotificationManager);
  ...
  protected onLinkClicked(notificationId: string): void {
    ...
    this._notificationManager.remove(notificationId);
  }
}
...
<div class="docs-top-level-overview">
  ...
  A component for displaying notifications that appear on top of the main interface. Notifications can be positioned at various locations and automatically dismissed after a specified duration.

  ### Features
  - Displays notifications from NotificationManager
  ...
  <org-notifications xPosition="right" yPosition="bottom" />
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default notifications positioned at top-center. Use the controls below to interact with the component.',
      },
    },
  },
  render: (args) => ({
    props: args,
    template: `<story-notifications-default-story />`,
    moduleMetadata: {
...
export const Positions: Story = {
  ...
  render: () => ({
    template: `<story-notifications-positions-story />`,
    moduleMetadata: {
      imports: [NotificationsPositionsStory],
    },
  }),
};
...
export const Colors: Story = {
  ...
  render: () => ({
    template: `<story-notifications-colors-story />`,
    moduleMetadata: {
      imports: [NotificationsColorsStory],
    },
  }),
};
...
export const AutoClose: Story = {
  ...
  render: () => ({
    template: `<story-notifications-auto-close-story />`,
    moduleMetadata: {
      imports: [NotificationsAutoCloseStory],
    },
  }),
};
...
export const UpdateDynamically: Story = {
  ...
  render: () => ({
    template: `<story-notifications-update-dynamically-story />`,
    moduleMetadata: {
      imports: [NotificationsUpdateDynamicallyStory],
    },
  }),
};
...
export const Accessibility: Story = {
  ...
  render: () => ({
    template: `<story-notifications-accessibility-story />`,
    moduleMetadata: {
      imports: [NotificationsAccessibilityStory],
    },
  }),
};
...
export const LinkAction: Story = {
  ...
  render: () => ({
    template: `<story-notifications-link-action-story />`,
    moduleMetadata: {
